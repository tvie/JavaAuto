...
public class Carousel {
    ...
    public void testCarousel() throws Exception {
        ...
        WebElement popup = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".subscription-popup__blocks")));
        driver.findElement(By.cssSelector("button.z-2:nth-child(1) > svg:nth-child(1)")).click();
        WebElement favouriteproduct = driver.findElement(By.xpath("//favorite-products[@class='favorite-products favorite-products--layout-content-left favorite-products--height-adapt block md:flex flex-nowrap overflow-hidden']"));
        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", favouriteproduct);
        Thread.sleep(3000);
